...
class ConfusionMatrix:
    ...
    def __init__(self, nc, conf=0.85, iou_thres=0.25):
    ...
    def process_batch(self, detections, labels):
        ...
        n = matches.shape[0] > 0
        m0, m1, _ = matches.transpose().astype(int) #labels, detect, iou
    ...
    def plot(self, normalize=True, save_dir="", names=()):
        ...
        fig.savefig(Path(save_dir) / "confusion_______matrix.png", dpi=250)
        plt.close(fig)
